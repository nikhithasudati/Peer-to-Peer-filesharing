...
public class PeerProcess1002 {
    public static void main(String[] args) throws Exception{
        ...
        PeerProcess p2pshare = new PeerProcess(6008,pieceid,prefneighbourCount,unchokeintfeatures,optunchokeintfeatures,bitspace);
        ...
        for(String eachpeer:peerlist){
            ...
            if(Integer.parseInt(peerinfo[0]) == pieceid){
                ...
                if(peerinfo[peerinfo.length-1].equals("1")) {
                    int capacity = p2pshare.enumData("bitTorrents/peer_1002/"+flname);
